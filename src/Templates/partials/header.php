...
<header class="fixed top-0 left-0 right-0 z-50 h-20 px-8 py-6 flex items-center justify-between header-footer-bg">
    <!-- Logo -->
    ...
    <nav class="flex items-center gap-4 text-sm font-medium">
        ...
        <a href="https://www.instagram.com/mater_natura/" target="_blank" class="hover:text-gray-600 transition-colors no-underline text-black" aria-label="Instagram">
